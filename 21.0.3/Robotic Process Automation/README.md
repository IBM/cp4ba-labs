...
The labs requires an IBM RPA environment which can be reserved [here](https://techzone.ibm.com/collection/cloud-pak-for-business-automation-cp4ba-rpa). Once you have reserved an environment, you will receive a link to the environment via email. 
