...
The lab document below allows you to perform the Client Onboarding scenario in its older version without the AI-enhancements of IBM Content Assistant, IBM Workflow genAI capability, and IBM Workplace Assistant. This is especially useful in environments, where these capabilities are not available.
