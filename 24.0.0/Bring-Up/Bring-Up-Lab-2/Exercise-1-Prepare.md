...
The preparation of a bastion host is discussed in the documentation on this page: [Preparing a client to connect to the cluster](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/24.0.0?topic=deployment-preparing-client-connect-cluster).
...
The OpenShift cluster was configured using OCP version 4.14.29. It will host the PostgreSQL and CP4BA containers which you will install 
