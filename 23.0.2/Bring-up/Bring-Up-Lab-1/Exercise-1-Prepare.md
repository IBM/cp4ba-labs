...
6. On the next page, provide the necessary information: Select the **Purpose**, for example **Education**, a **Purpose description**, select the **Preferred Geography** (ideally closest to your location) and select the **End date and time** for the reservation. Plan for at least 6 hours, maybe more.
